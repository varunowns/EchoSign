...
def main():
    ...
    parser.add_argument("--data-dir", default="backend/data/processed", help="Data directory")
    parser.add_argument("--model", default="backend/models/asl_sequence.pt", help="Model path")
    ...
    if args.train:
        ...
        # Fit label encoder on combined labels to avoid missing classes
        from sklearn.preprocessing import LabelEncoder
        all_labels = train_data['labels'] + val_data['labels']
        label_encoder = LabelEncoder()
        label_encoder.fit(all_labels)

        # Create datasets with shared encoder
